...
void Cloud3()
{
    ...
    circle(0.02,0.55,0.15);
*/
glColor3f(0.80,0.80,0.80);
   circle(-0.09,0.80,0.15);
     circle(-0.01,0.80,0.15);
    circle(0.08,0.83,0.15);
   circle(0.02,0.72,0.15);
}
void Tree1()
{
...
int main(int argc,char** argv)
{
    ...
    glutCreateWindow("RiverineVillage");
    myInit();
    ...
    glutTimerFunc(25,update,0);
    //PlaySound(TEXT("jodi-mon-kade-tumi-chole-esho(online-audio-converter.com).wav"),NULL,SND_SYNC);

        sndPlaySound("C:\\Users\\tahme\\Downloads\\jodi-mon-kade-tumi-chole-esho (online-audio-converter.com).wav",SND_ASYNC);
